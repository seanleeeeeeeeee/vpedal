...
- Runs with OpenCV on Raspberry Pi 5 with IMX219 and similar cameras (change your config.json accordingly)
- Straightforward setup: set corner points, keypress detection parameters adjusted semi-automatically
